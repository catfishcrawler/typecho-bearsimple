...
<div id="read__mode__content"  style="margin-top:50px">
  ...
  <div class="content">
    {$title}
   <div class="sub header" style="margin-top:15px;"><div class="ui basic label">
  <i class="user icon"></i> 
  {$author}
<div class="detail"> <i class="pen icon"></i>撰写于 {$date}</div>
</div>
    </div>
  </div>
</h1>   
...
echo '<div class="ui top left dropdown button" onclick="isHidden(\'div_reward\')">
  ...
  <div class="ui top left dropdown button">
    ...
    if($options['RewardOpenAlipay'] == true){echo'<div class="item" id="bs-alipay"><i class="alipay blue icon"></i>支付宝打赏</div>';}
    echo'
  </div>
</div>';   
}
