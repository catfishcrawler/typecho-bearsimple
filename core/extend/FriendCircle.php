...
?>
        ...
        <li id="<?php $this->theId(); ?>" <?php echo $hidden;?>><div class="friendcircle-main-level"><div class="friendcircle-avatar"><img <?php echo lazyload('auto');?>src="<?php echo $avatar; ?>"></div><div class="friendcircle-box"><div class="friendcircle-head"><h3 class="friendcircle-name by-author"><?php echo $this->author; ?></h3> </div>
        ...
        <?php 
        $keys = array(".mp3",".mp4",".mov",".wmv",".wma",".rmvb",".rm",".avi",".flv",".ogg",".oga",".ogv");
...
<?php endif;?>
 ...
 <div class="circle-pictures">
       ...
       <section class="friendcircle-action" id="friendcircle-action-<?php echo $this->coid;?>">
          <div class="ui icon mini label circle-action" data-toolbar="friendcircle-actions" data-toolbar-style="dark" data-coid="<?php echo $this->coid;?>">
