...
<div class="post-meta"><spans><i class="user icon"></i><a class="post-author" href="<?php $this->author->permalink(); ?>"><?php $this->author(); ?></a></spans><span><i class="time outline icon"></i><time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time></span><?php if($this->fields->Hot == '1'): ?>  <span><i class="hotjar icon" data-scid="<?php echo $this->cid; ?>"></i>热度: <hot id="ahot"></hot>°C</span><?php endif; ?><span><spans class="article_change"><i class="font icon"></i><spans class="article_change_m">默认</spans> / <spans class="article_change_k">楷体</spans> / <spans class="article_change_xlwk">霞鹜文楷体</spans></spans></span> <span id="fontsizes"><i class="text height icon"></i></span> <?php if(Bsoptions('Readmode') == true): ?><span id="read"><i class="book reader icon"></i></span><?php endif; ?> <write id="editbtn" style="display:none;">  <span onclick="window.open('<?php $this->options->adminUrl('/write-page.php?cid='.$this->cid); ?>','_self')"><i class="pencil icon"></i></span></write><?php if(Bsoptions('Poster') == true): ?> <span class="bear-btn-bwqr bear-share-poster j-bwqr-poster-btn" data-cid="<?php echo $this->cid;?>" id="poster-btn"><i class="newspaper icon"></i></span><?php endif; ?></div>
