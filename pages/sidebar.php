...
<?php if(!empty(Bsoptions('Search')[0]) && @in_array('sidebar',Bsoptions('Search'))) :?>
   <div class="widget">
<h4 class="ui grey horizontal left aligned divider header">
  <i class="search plus icon"></i>搜索</h4>
...
<?php if(Bsoptions('ClockModule') == true) :?>
 <div class="widget">
         <h4 class="ui grey horizontal left aligned divider header">
  <i class="hourglass half icon"></i>人生进行时</h4>
<h4 class="ui grey horizontal left aligned divider header">
  今年过了: <span id="yearprog"></span>
</h4>
...
<div class="widget">
<h4 class="ui grey horizontal left aligned divider header">
  <i class="folder open outline icon"></i>分类</h4>
...
<a href="<?php $categorys->permalink(); ?>" title="<?php $categorys->name(); ?>"><?php $categorys->name(); ?> </a><div class="ui mini left pointing label" style="float:right">
...
<div class="item" hrefs="<?php echo $child['permalink'] ?>" title="<?php echo $child['name']; ?>"><?php echo $child['name']; ?> <div class="ui mini left pointing label" style="margin-left:5px">
    <?php echo $child['count']; ?>
</div> 
</div>

<?php } ?>
</div></div><div class="ui mini left pointing label" style="float:right">
<?php echo $categorys->count(); ?>
</div></li>
...
<div class="widget">
    <h4 class="ui grey horizontal left aligned divider header">
  <i class="newspaper icon"></i>最近文章</h4>
    <ul class="post-list">
...
<h4 class="ui grey horizontal left aligned divider header">
  <i class="comment dots outline icon"></i>最新评论</h4>
...
<div class="widget"><h4 class="ui grey horizontal left aligned divider header">
  <i class="laugh wink outline icon"></i>友情链接</h4><ul></ul><?php if(empty(Bsoptions('FriendLink'))) :?>
    <center>
