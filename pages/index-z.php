<?php if(Bsoptions('AdControl') == true && Bsoptions('AdControl3') == true) :?>
<?php billboard(Bsoptions('AdControl3_style'),'index'); ?>
  <?php endif; ?>
<div class="pure-g" id="layout">
 ...
 <?php if(Bsoptions('Slidersss') == true && Bsoptions('SliderIndexs') == true) :?>
	<div id="bearslider" style="display:none">
...
<?php endif; ?>
  ...
  <div class="blog-card">
    <div class="meta">
      <div class="photo" style="background-image: url(<?php if(thumb($this) !== ""): ?><?php echo thumb($this); ?><?php else:?><?php AssetsDir();?>assets/images/newstyle_default.jpg<?php endif; ?>)"></div>
    </div>
  ...
  <div class="bs-simplestyle-column">
    ...
    <div class="bs-simplestyle-post-module">
      ...
      <div class="bs-simplestyle-post-content">
        ...
        <?php if(Bsoptions('Article_expert') == 1): ?><p class="bs-simplestyle-description"><?php if($this->fields->excerpt == null): ?><?php echo cutexpert($this->excerpt,articledecnum());?>	<?php else: ?>
			<?php $this->fields->excerpt(); ?>
