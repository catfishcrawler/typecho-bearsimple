...
<div class="widget-special bsmenutree" style="display:none">
      <?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
...
<?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?><?php endif; ?>
            ...
            <div class="bs-new2authorcard">
                <div class="bs-new2authorcard-header" style="background-image: url(<?php if(Bsoptions('AuthorBackground')):?><?php echo Bsoptions('AuthorBackground'); ?><?php else:?><?php AssetsDir();?>assets/images/default_background.webp<?php endif; ?>);">
                    <div class="bs-new2authorcard-photo">
                        <img src="<?php echo Bsoptions('AuthorAvatar') ?>" alt="">
                    </div>
                </div>
...
<?php if($stat->publishedPostsNum > '999'){echo '999+';}else{echo $stat->publishedPostsNum();} ?>
  ...
  <div class="bs_newAuthor_card">
      <div class="bs_newAuthor_card-header" style="background-image: url(<?php echo Bsoptions('AuthorAvatar') ?>)"></div>
...
<?php if(!empty(Bsoptions('Search')[0]) && @in_array('sidebar',Bsoptions('Search'))) :?>
 ...
 <div class="ui segment"><?php endif; ?>
<h4 class="ui grey horizontal left aligned divider header">
  <i class="search plus icon"></i>搜索</h4><ul class="category-list">
<form name="search" class="ui form" role="search" method="get" id="searchform">
  ...
  <div class="ui icon input" style="width:100%">
    ...
    <i hrefx="?s=" class="search plus link icon"></i>
  </div>
</div>
...
<?php if(Bsoptions('ClockModule') == true) :?>
 ...
 <div class="ui segment"><?php endif; ?>
          <h4 class="ui grey horizontal left aligned divider header">
  <i class="hourglass half icon"></i>人生进行时
</h4>
<h4 class="ui grey horizontal left aligned divider header">今年过了: <span id="yearprog"></span>
</h4>
<div class="progress" style="height: 10px;">
                        <div class="progress-bar">
                            <div class="progress-inner progress-inner-1"  id="yearbar"></div>
                        </div>
                    </div>


 <h4 class="ui grey horizontal left aligned divider header">本月过了: <span id="monthprog"></span>
</h4>
<div class="progress" style="height: 10px;">
<div class="progress-bar">
                            <div class="progress-inner progress-inner-2"  id="monthbar"></div>
                        </div>
        
                    </div>

<h4 class="ui grey horizontal left aligned divider header">今天过了: <span id="dayprog"></span>
</h4>
<div class="progress" style="height: 10px;">
<div class="progress-bar">
                            <div class="progress-inner progress-inner-3"  id="daybar"></div>
                        </div>
        
                    </div>
</div>
<?php if(Bsoptions('rightType') !== "0"): ?></div><?php endif; ?><?php endif; ?>
 
<?php if(Bsoptions('Cate') == true) :?>
<!--分类模块-->
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?><h4 class="ui grey horizontal left aligned divider header">
  <i class="folder open outline icon"></i>分类</h4><ul class="category-list">
...
<a href="<?php $categorys->permalink(); ?>" title="<?php $categorys->name(); ?>"><?php $categorys->name(); ?>  <div class="ui circular grey mini label" style="float:right">
    <?php $categorys->count(); ?></div></a>
</li>
<?php } else { ?>
<li>
<div class="ui dropdown"><a  href="<?php $categorys->permalink(); ?>"><?php $categorys->name(); ?></a><i class="dropdown icon"></i>
<div class="menu">
<?php foreach ($children as $mid) { ?>
<?php $child = $categorys->getCategory($mid); ?>
<div class="item" hrefs="<?php echo $child['permalink'] ?>" title="<?php echo $child['name']; ?>"><?php echo $child['name']; ?> <div class="ui circular grey mini label">
...
</div><?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?>
<?php endif; ?>
...
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?><h4 class="ui grey horizontal left aligned divider header">
  <i class="newspaper icon"></i>最近文章</h4><ul class="post-list">
 <?php if(Bsoptions('LastArticleNumber') !== '') :?>
 <?php $this->widget('Widget_Post_hot@hot', 'pageSize='.Bsoptions('LastArticleNumber'))->to($hot); ?>
 <?php while($hot->next()): ?>
 <li class="post-list-item"><a class="post-list-link" href="<?php $hot->permalink() ?>"><?php $hot->title(); ?></a><small><?php echo date('Y/m/d',$hot->created); ?>  -  <?php $hot->commentsNum('暂无评论', '1 条评论', '%d 条评论'); ?></small></li>
 <?php endwhile; ?>
            <?php else: ?>
 ...
 <li class="post-list-item"><a class="post-list-link" href="<?php $hot->permalink() ?>"><?php $hot->title(); ?></a><small><?php echo date('Y/m/d',$hot->created); ?>  -  <?php $hot->commentsNum('暂无评论', '1 条评论', '%d 条评论'); ?></small></li>
 <?php endwhile; ?>
            <?php endif; ?></ul></div><?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?>
<?php endif; ?>

<?php if(Bsoptions('lastcomment') == true) :?>
<div class="widget widget_comments"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?>
    <h4 class="ui grey horizontal left aligned divider header">
  <i class="comment dots outline icon"></i>最新评论
</h4>
    <?php lastComments(); ?>
    
</div>
<?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?>
<?php endif; ?>
...
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?><h4 class="ui grey horizontal left aligned divider header">
  <i class="laugh wink outline icon"></i>友情链接
</h4><ul></ul><?php if(empty(Bsoptions('FriendLink'))) :?> <center>
...
<?php endforeach; ?>
<?php endif; ?></div><?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?>
  <?php endif; ?>
<?php endif; ?>
...
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?>
<h4 class="ui grey horizontal left aligned divider header">
  <i class="tags icon"></i>标签云</h4><div class="tags-list">
<?php Typecho_Widget::widget('Widget_Metas_Tag_Cloud','ignoreZeroCount=true&limit='.tagcloudnum())->to($tags); ?>
          <?php if($tags->have()): ?>
    <?php while ($tags->next()): ?>
      <div class="tag-item"><a href="<?php $tags->permalink();?>">#<?php $tags->name(); ?></a></div>
      <?php endwhile; ?>
      <?php else: ?>
     <div class="tag-item"><a href="#">暂无标签</a></div>
      <?php endif; ?>
   </div>
</div><?php if(Bsoptions('rightType') !== "0"): ?></div></div><?php endif; ?>
    <?php endif; ?>
